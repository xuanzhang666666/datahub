...
#   sh xander/run_hive_metastore_dw_order_v1_lineage_ingest.example.sh
#
# Post-ingest: xander/verify_dw_order_v1_storage_lineage.example.sh
# BLF context (schedule + DDL cues): xander/blf_collect_dw_order_v1_facts.example.sh
# Extra table-table edges (optional): xander/openlineage_optional_note.txt
#
# neo4j2 server: deploy flat files → /data/datahub/scripts/, then xander/run_hive_lineage_on_neo4j2.sh
# or from laptop only docker: xander/exec_hive_lineage_ingest_via_bastion.example.sh
#
