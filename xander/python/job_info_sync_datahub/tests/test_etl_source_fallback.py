...
def test_table_name_candidates_strip_known_scheduling_suffixes() -> None:
    assert fallback.table_name_candidates("app_table_merge") == ["app_table_merge", "app_table"]
    assert fallback.table_name_candidates("app_table_test") == ["app_table_test", "app_table"]
    assert fallback.table_name_candidates("app_table") == ["app_table"]
